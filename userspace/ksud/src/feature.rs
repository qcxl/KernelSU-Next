...
impl FeatureId {
    ...
    pub const fn name(self) -> &'static str {
        match self {
            ...
            Self::SetSelinuxEnforce => "set_selinux_enforce",
    ...
    pub const fn description(self) -> &'static str {
        match self {
            ...
            Self::SetSelinuxEnforce => {
                "SELinux Enforce - toggle SELinux enforcing mode (requires CONFIG_SECURITY_SELINUX_DEVELOP)"
            }
            Self::AvcSpoof => {
...
fn parse_feature_id(name: &str) -> Result<FeatureId> {
    match name {
        ...
        "set_selinux_enforce" | "5" => Ok(FeatureId::SetSelinuxEnforce),
